...
public class Mobil extends KendaraanAbstrk {
    // Variabel/Atribut yang hanya milik class Mobil
    final private int perjam = 10000;
    ...
    public Mobil(String brand, String jenis, String plat, String waktuDatang, String waktuKeluar, boolean masihParkir) {
        this.brand = brand;
        this.jenis = jenis;
        this.plat = plat;
